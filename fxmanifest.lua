...
game 'gta5'
name 'ox_inventory'
author 'Overextended & ExterFramework'
version '2.43.5'
...
server_scripts {
    ...
    'init.lua',
    'sv_Exterfunctions.lua',
}

client_script {'init.lua', '@qbx_core/modules/playerdata.lua', 'cl_Exterfunctions.lua'}
